...
The regular polygon is of pace 1  and ties vertice \#1 to vertice \#2 
and then vertice \#2 to vertice \#3 and so on.

The first star polygon is of pace 2  and ties vertice \#1 to vertice
\#3  and then vertice \#3 to vertice \#5 and so on.
...
2.  *ν*(2  *p*)=2  the first term is the pace of the first star polygon 
    i.e. 2 
3.  *ν*(3  *p*)=(*p* − 1)/2
4.  *ν*(*n* + 2  *p*)=*ν*(*n*  *p*)+1  *w**h**e**n* *n* *i**s* *e**v**e**n*
5.  *ν*(*n* + 2  *p*)=*ν*(*n*  *p*)−1  *w**h**e**n* *n* *i**s* *o**d**d*
6.  Last term *η* is
